...
// $('.result-table').each(function foldUpTable(index, el) {
//   $(el).hide();
//   $('<div>Show result ' + index + '</div>').click(function showTable() {
//     $(el).toggle();
//   }).insertBefore($(el));
// });
...
},{"./helpers":3,"lodash.foreach":11,"lodash.groupby":12}],3:[function(require,module,exports){
'use strict';
...
},{"lodash.foreach":11}],4:[function(require,module,exports){
'use strict';
...
},{"./helpers":3,"lodash.foreach":11,"lodash.groupby":12}],5:[function(require,module,exports){
var each = require('lodash.foreach');
...
},{"./helpers":3,"lodash.foreach":11}],6:[function(require,module,exports){
// <details> polyfill
...
},{"./cookieSettings":8,"hof-frontend-toolkit":7}],10:[function(require,module,exports){
/*!
